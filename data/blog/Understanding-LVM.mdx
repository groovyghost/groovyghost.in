...
tags: [linux, storage]
draft: false
summary: Have you ever wanted to take a secondary drive and just combine onto your exsiting system,Well you’re in luck if you are using Linux specifically with LVM.But what is LVM?
---
...
<img className="inline" src="/static/images/Blog/lvm-guide.jpg" alt="LVM" />
